...
package body Concorde.Markets is
   ...
   subtype Market_Offer_Class is
     Concorde.Handles.Market_Offer.Market_Offer_Class;

   procedure Execute_Transaction
     (Market                        : Concorde_Market;
      Buyer, Seller                 : Agent_Class;
      Buyer_Account, Seller_Account : Account_Class;
      Buyer_Stock, Seller_Stock     : Has_Stock_Class;
   ...
   begin
      return Quantity : Quantity_Type := Zero do
         for Item of
           Concorde.Handles.Market_Offer
             .Select_Priority_Offer_Bounded_By_Priority
   ...
   is
      ...
      type Offer_Type is
         record
            ...
            Offer     : Concorde.Handles.Market_Offer.Market_Offer_Handle;
      ...
      procedure Add_To_Queue
        (Queue     : in out Offer_Maps.Map;
         ...
         Has_Stock : Has_Stock_Class;
         Offer     : Market_Offer_Class;
         Price     : Price_Type;
         Quantity  : Quantity_Type);
      ...
      is
         ...
         Rec      : constant Offer_Type :=
                      Offer_Type'
                        (Agent     => Agent.To_Agent_Handle,
                         Account   => Account.To_Account_Handle,
                         Has_Stock => Has_Stock.To_Has_Stock_Handle,
                         Offer     => Offer.To_Market_Offer_Handle,
                         Quantity  => Quantity);
      begin
...
--                       & " added to queue");
      ...
      begin
         ...
         for I in 1 .. Asks.Weighted_Vector.Last_Index loop
            declare
               Offer : constant Market_Offer_Class :=
...
--                 & Db.To_String (Active.Get_Market_Offer_Reference));
   ...
   begin
      Log_Market
        (Market,
         Concorde.Agents.Describe (Buyer)
         & " buys from "
         & Concorde.Agents.Describe (Seller)
         & " "
   ...
   is
      ...
      use Concorde.Money;
      Price : constant Price_Type := Commodity.Base_Price;
   begin
      return Price;
   ...
   begin
      Concorde.Logging.Log
        (Actor    =>
           "Market" & Concorde.Db.To_String (Market.Reference_Market),
         Location => Market.World.Name,
         Category => "",
         Message  => Message);
   end Log_Market;
   ...
   is
      use type Concorde.Db.Offer_Type;
      Item : constant Market_Offer_Class :=
        Concorde.Handles.Market_Offer.Get_By_Market_Offer
          (Market, Agent, Commodity);
   begin
