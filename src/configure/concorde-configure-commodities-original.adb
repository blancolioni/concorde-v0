...
package body Concorde.Configure.Commodities is
   ...
   use all type Concorde.Db.Consumer_Class;

   type Happiness_Rating is range 0 .. 16;

   function Happiness_Level
     (Class : Concorde.Db.Consumer_Class)
   ...
   package Commodity_Maps is
     new WL.String_Maps (Concorde.Handles.Commodity.Commodity_Handle,
                         Concorde.Handles.Commodity."=");
   ...
   function Create_Building_Module
     (Config : Tropos.Configuration)
      return Concorde.Handles.Commodity.Commodity_Handle;
   ...
   procedure Deserialize_Common
     (Commodity : in out Concorde.Handles.Commodity.Commodity_Class;
      Config : Tropos.Configuration);
   ...
   is
      ...
      function Category return Concorde.Db.Resource_Category
      is (if Config.Get ("mineral") then Concorde.Db.Mineral
          else raise Constraint_Error with
   ...
   begin
      Constraint.Update_Resource_Constraint
        ...
        .Set_District (Concorde.Db.Stellar_Orbit_Zone'Value (Config.Value))
          .Done;
