...
with Concorde.Color.Table;

package body Concorde.Color is

   function Parse_Hex_Color (Spec : String) return Concorde_Color;
   ...
   begin
      ...
      elsif Concorde.Color.Table.Exists (Item) then
         return Concorde.Color.Table.Get (Item);
      else
         return White;
      end if;
   end From_String;

   function Parse_Hex_Color (Spec : String) return Concorde_Color is
